...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="526" id="AutoNumber1" bgcolor="#FFF19F" height="4">
  ...
  <tr>
    ...
    <p size="3" align="center"><b>Dados de <%=rs("nick")%> </b> </p>
    <table border="0" cellpadding="0" align="center" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="80%" id="AutoNumber2">
      <form method="POST" action="ops2c.asp?action=atualizar">
     <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">Deck</font></b></td>
        <td width="50%">
        <input type="texte" value="<%= lista("deck")%>" size="20" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" name="deck"></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">
        Experiência</font></b></td>
        <td width="50%">
        <input type="texte" value="<%= lista("exp")%>" size="20" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" name="exp"></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">Professor</font></b></td>
        <td width="50%">
        <input type="texte" value="<%= lista("professor")%>" size="20" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" name="professor"></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">Dinheiro</font></b></td>
        <td width="50%">
        <input type="texte" value="<%= lista("dinheiro")%>" size="20" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" name="dinheiro"></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">E-Mail</font></b></td>
        <td width="50%">
        <input type="texte" value="<%= lista("email")%>" size="20" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" name="email"></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">Itens</font></b></td>
        <td width="50%">
      <font color="#FFFFFF" face="Tahoma" size="2">
        <textarea rows="10" name="Itens" cols="32" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" ><%= lista("itens")%></textarea></font></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">Cartas</font></b></td>
        <td width="50%">
      <font color="#FFFFFF" face="Tahoma" size="2">
        <textarea rows="10" name="cartas" cols="32" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" ><%= lista("cartas")%></textarea></font></td>
      </tr>
      <tr>
        <td width="50%" align="right"><b><font face="Verdana" size="1">
        ...
        <td width="50%">
      <font color="#FFFFFF" face="Tahoma" size="2">
        <textarea rows="10" name="comentarios" cols="32" style="color: #000000; font-family: Verdana; font-size: 8 pt; border: 1px solid #009933; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" ><%= lista("comentarios")%></textarea></font></td>
      </tr>
      <tr>
